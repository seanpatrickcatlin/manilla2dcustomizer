================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Manilla2DConfig Project Overview
===============================================================================

The application wizard has created this Manilla2DConfig application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Manilla2DConfig application.

Manilla2DConfig.vcproj
...
Manilla2DConfig.h
    ...
    project specific headers and declares the CManilla2DConfigApp application class.

Manilla2DConfig.cpp
    This is the main application source file that contains the application
    class CManilla2DConfigApp.


Manilla2DConfigppc.rc
...
res\Manilla2DConfigppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\Manilla2DConfig.ico
...
Manilla2DConfigDlg.h, Manilla2DConfigDlg.cpp - the dialog
    These files contain your CManilla2DConfigDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Manilla2DConfig.pch and a precompiled types file named StdAfx.obj.
